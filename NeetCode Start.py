...
categories = {
    ...
    "10. Isomorphic Strings.py",
    "11. Word Pattern.py",
    "12. Longest Palindrome.py",
    "13. Largest Substring Between Two Equal Characters.py",
    "14. First Unique Character in a String.py",
    "15. Find Common Characters.py",
    "16. Largest 3-Same-Digit Number in String.py",
    "17. Circular Sentence.py",
    "18. Maximum Score After Splitting a String.py",
    "19. Path Crossing.py",
    "20. Redistribute Characters to Make All Strings Equal.py",
    "21. Longest Consecutive Sequence.py",
    "22. Encode and Decode TinyURL.py",
    "23. Special Array with X Elements Greater than or Equal X.py",
    "24. Minimum Numbers of Operations to Make Array Empty.py",
    "25. Text Justification.py",
    "26. Naming a Company.py",
    "27. Minimum Remove to Make Valid Parentheses.py",
    "28. Uncommon Words from Two Sentences.py",
    "29. Word Subsets.py",
    "30. Two Sum.py",
    "31. Best Time to Buy and Sell Stock II.py",
    "32. Contains Duplicate.py",
    "33. Group Anagrams.py",
    "34. Remove Element.py",
    "35. Unique Email Addresses.py",
    "36. Majority Element.py",
    "37. Next Greater Element I.py",
    "38. Find Pivot Index.py",
    "39. Kth Distinct String in an Array.py",
    "40. Range Sum Query - Immutable.py",
    "41. Find All Numbers Disappeared in an Array.py",
    "42. Find Missing and Repeated Values.py",
    "43. Maximum Number of Balloons.py",
    "44. Majority Element II.py",
    "45. Subarray Sum Equals K.py",
    "46. Subarray Sums Divisible by K.py",
    "47. Make Sum Divisible by P.py",
    "48. Number of Sub-arrays With Odd Sum.py",
    "49. Number of Zero-Filled Subarrays.py",
    "50. Find All Duplicates in an Array.py",
    "51. Find the Length of the Longest Common Prefix.py",
    "52. Count Unguarded Cells in the Grid.py",
    "53. Number of Submatrices that Sum to Target.py",
    "54. First Missing Positive.py",
    "55. Longest Common Prefix.py",
    "56. Pascal's Triangle.py",
    "57. Longest Strictly Increasing or Strictly Decreasing Subarray.py",
    "58. Maximum Ascending Subarray Sum.py",
    "59. Unique Length 3 Palindromic Subsequences.py",
    "60. Maximum Product of The Length of Two Palindromic Subsequences.py",
    "61. Sort an Array.py",
    "62. Sort Colors.py",
    "63. Relative Sort Array.py",
    "64. Sort the People.py",
    "65. Sort Array by Increasing Frequency.py",
    "66. Top K Frequent Elements.py",
    "67. Sort Characters By Frequency.py",
    "68. Sort the Jumbled Numbers.py",
    "69. Design HashSet.py",
    "70. Design HashMap.py",
    "71. Design a Food Rating System.py",
    "72. Design Parking System.py",
    "73. Design Underground System.py",
    "74. Insert Delete Get Random O(1).py",
    "75. Can Place Flowers.py",
    "76. Find Polygon with the Largest Perimeter.py",
    "77. Maximum Product Difference Between Two.py",
    "78. Find Missing and Repeated Values.py",
    "79. Path Crossing.py",
    "80. Optimal Partition of String.py",
    "81. Shifting Letters II.py",
    "82. Sequential Digits.py",
    "83. Number of Ways to Split Array.py",
    "84. Find The Index of The First Occurrence in a String.py",
    "85. Minimum Penalty for a Shop.py",
    "86. Champagne Tower.py",
    "87. Sum of Absolute Differences in a Sorted Array.py",
    "88. Divide Array Into Arrays With Max Difference.py",
    "89. Count Number of Bad Pairs.py",
    "90. Grid Game.py"
  ],
    "2. Two Pointer": [
    "1. Reverse String.py",
